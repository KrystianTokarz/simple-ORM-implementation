...
public class SelectOperationTest {
    ...
    public void shouldGenerateSelectSqlQueryWhenIdValueExist() throws Exception{
        ...
        SqlOperation selectOperation = new SelectOperation(testEntity.getClass().getSimpleName(), properties);
        ...
        assertThat(result).containsIgnoringCase("SELECT * FROM");
    ...
    public void shouldGenerateSelectSqlQueryWhenIdValueNotExist() throws Exception{
        ...
        assertThat(result).containsIgnoringCase(yearFieldName + " = " + year.toString());
